import {
  ...
  function getBloodPressure (sDate, eDate, setFunc)
  new Promise((resolve, reject) =>  {
    switch (Platform.OS) {
      case 'ios':
        let options = {
  ...
  function getStepCount(dateOptions, setFunc)
  new Promise((resolve, reject) => {
    switch (Platform.OS) {
      case 'ios':
  ...
  function getHeight(inputOption, setFunc)
  new Promise((resolve, reject) => {
    switch (Platform.OS) {
      case 'ios':
  ...
  function getWeight(inputOption, setFunc)
  new Promise((resolve, reject) => {
    switch (Platform.OS) {
      case 'ios':
  ...
  module.exports.getBloodPressure = getBloodPressure;
  module.exports.getStepCount = getStepCount;
